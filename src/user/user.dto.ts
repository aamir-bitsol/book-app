...
export class CreateUserDto{
    ...
    name: string;
    @ApiProperty({description:"Contact of user", type: "string", required: true})
    contact: string;
    @ApiProperty({description:"Address of user", type: "string", required: true})
    address: string;
    @ApiProperty({description:"Username of user", type: "string", required: true})
    username: string;
    @ApiProperty({description:"Password of user", type: "string", required: true})
    password: string;
    @ApiProperty({description:"Image of user", type: "string", required: false})
    image: string;
}
